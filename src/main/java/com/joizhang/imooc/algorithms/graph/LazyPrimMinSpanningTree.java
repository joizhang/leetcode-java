...
import com.joizhang.imooc.datastructure.heap.MinHeap;
 ...
 * @author joizhang
 */
public class LazyPrimMinSpanningTree<W extends Number & Comparable<W>> {

    private final WeightedGraph<W> graph;

    private final MinHeap<Edge<W>> minHeap;
